...
<span style="font-size: 18px;">**Statement of Principles**</span>  
...
<span style="font-size: 18px;">**Experience in DEIJ Advocacy**</span>

<div style="display: flex; align-items: center"> <div style="width: 1000px;">

```{r yawh, echo=FALSE, fig.cap="<span style='font-size: 14px;'>*You Are Welcome Here campaign logo*</span>", out.width = '80%', results='asis'}
knitr::include_graphics("yawh.png")
```
...
<span style="font-size: 18px;">*You Are Welcome Here Campaign*</span>
...
<div style="display: flex; align-items: center;"> <div style="width: 1800px;">

```{r risingtides, echo=FALSE, fig.cap="<span style='font-size: 14px;'>*Rising TIDES advisors at Restore America's Estuaries meeting in 2024*</span>", out.width = '80%', results='asis'}
knitr::include_graphics("risingtides2.jpg")
```
...
<span style="font-size: 18px;">*Rising TIDES*</span>
