...
```{r pressure, echo=FALSE, fig.cap="<span style='font-size: 22px; font-weight: bold;'>Savannah H. Swinea</span> <br> <span style='font-size: 16px;'>Postdoctoral Researcher at North Carolina State University</span>", out.width = '80%', results='asis'}
